...
export async function POST(req) {
  try {
    const { fullName, email, companyName, country, description } = await req.json();
    ...
    const mailOptions = {
      ...
      to: "kncfuturetech@gmail.com",
      // Improved Subject Line (Puts Company Name first if available)
      subject: `New Business Inquiry: ${companyName || fullName} - Gayatri Agency`,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
          ...
          <div style="background-color: #113741; padding: 25px; text-align: center;">
            ...
            <p style="color: #f97316; margin: 8px 0 0 0; font-size: 13px; font-weight: bold; letter-spacing: 1px; text-transform: uppercase;">New Business Inquiry</p>
          </div>
          
          <div style="padding: 30px; background-color: #ffffff;">
            <p style="font-size: 15px; color: #475569; margin-top: 0; margin-bottom: 25px;">A new logistics and warehousing inquiry has been submitted via the website.</p>
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #334155; font-size: 14px; font-weight: bold;">${companyName || "<span style='color: #94a3b8; font-style: italic; font-weight: normal;'>Not provided</span>"}</td>
              </tr>
              <tr>
                <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; font-weight: bold; color: #113741; font-size: 14px;">Country:</td>
                <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #334155; font-size: 14px;">${country || "<span style='color: #94a3b8; font-style: italic;'>Not provided</span>"}</td>
              </tr>
            </table>
            
            <div style="margin-top: 30px;">
              <h3 style="color: #113741; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px; border-bottom: 2px solid #113741; padding-bottom: 8px; display: inline-block;">Logistics Requirements</h3>
          ...
          <div style="background-color: #f1f5f9; padding: 20px; text-align: center; font-size: 12px; color: #64748b; border-top: 1px solid #e2e8f0;">
            This inquiry was generated automatically from the Gayatri Agency website.
          </div>
