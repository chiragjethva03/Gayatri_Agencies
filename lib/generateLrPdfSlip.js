...
const P = {
  ...
  transportGst:  [ 10,  9,  8, "left",  "normal"],
  ...
  cnorGst:      [ 38, 28,  7, "left",  "normal"],
  cnorMobile:   [ 78, 28,  7, "left",  "normal"],
  cneeGst:      [128, 28,  7, "left",  "normal"],
  cneeMobile:   [165, 28,  7, "left",  "normal"],
  ...
  freight:      [203, 32,  8, "right", "normal"],
  crossing:     [203, 38,  8, "right", "normal"],
  bc:           [203, 44,  8, "right", "normal"],
  doorDelivery: [203, 50,  8, "right", "normal"],
  rcm:          [203, 56,  8, "right", "normal"],
  subTotal:     [203, 62,  9, "right", "bold"],

  delivery:     [ 38, 62,  8, "left",  "normal"],
  eWayBill:     [ 83, 62,  8, "left",  "normal"],
...
function drawSlip(doc, lrData, consignorData, consigneeData, transportData, offsetY) {
  ...
  if (cityAddress || phones.length > 0) {
    ...
    if (cityAddress) {
      const fs    = cityAddress.length > 55 ? 6 : 7;
